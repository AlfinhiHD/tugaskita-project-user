...
const RequestTaskKeagamaanDialog = ({ task, openDialog, setOpenDialog }) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-blue-50">{task.title}</DialogTitle>
        </DialogHeader>
...
export default RequestTaskKeagamaanDialog;
