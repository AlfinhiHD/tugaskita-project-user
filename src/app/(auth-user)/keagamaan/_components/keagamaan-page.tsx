...
import useKeagamaan from "../_hooks/useKeagamaan";
import KeagamaanCard from "./keagamaan-card";
...
const KeagamaanPage = () => {
  ...
  return (
    <div className="page-wrapper bg-gradient-to-br from-purple-50 to-indigo-100 min-h-screen p-0 md:p-8">
      <div className="max-w-7xl mx-auto mt-3">
        <div className="flex justify-between items-center mb-8">
          <h1 className="font-bold text-2xl md:text-4xl text-purple-800 flex items-center">
            <ClipboardList className="mr-3 h-10 w-10" />
            Tugas Keagamaan
          </h1>
          <Link href="keagamaan/ajukan-tugas-keagamaan" passHref>
            ...
            {loadingTasks ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {currentTasks.map((task) => (
                  <KeagamaanCard key={task.id} task={task} />
                ))}
              </div>
            ) : (
